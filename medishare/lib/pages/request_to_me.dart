...
class RequestsToMePage extends StatefulWidget {
  ...
  @override
  State<RequestsToMePage> createState() => _RequestsToMePageState();
}

class _RequestsToMePageState extends State<RequestsToMePage> {
  ...
  void initState() {
    super.initState();
    _requests = _requestService.getRequestsByDonation(widget.donationId);
    _loadRequesters();
  }
    ...
    for (final request in requests) {
      if (!_requesters.containsKey(request.requesterId)) {
        try {
          ...
          setState(() => _requesters[request.requesterId] = user);
        } catch (e) {
  ...
  Future<void> _fulfillRequest(MedicineRequest request) async {
    try {
      await _requestService.updateRequestStatus(
        request.requestId,
        RequestStatus.fulfilled,
        assignedDonationId: widget.donationId,
      );
      ...
      builder: (context, snapshot) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Requests for this medicine will appear here',
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _buildRequestCard(request, requester);
          },
        );
      },
    );
  ...
  Widget _buildRequestCard(MedicineRequest request, UserModel? requester) {
    return Container(
